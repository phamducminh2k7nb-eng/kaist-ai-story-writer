...
export const LoginView: React.FC<LoginViewProps> = ({
  ...
  const previewOrigin = "https://kaist-ai-story-writer-production.up.railway.app";
        ...
        <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 w-full">
            <div className="w-full bg-white dark:bg-[#121215] border border-zinc-200/90 dark:border-zinc-800/90 rounded-2xl p-6 sm:p-7 shadow-xl shadow-zinc-900/5 dark:shadow-2xl backdrop-blur-md">
              ...
              {/* Google sign-in is shown only when a Client ID is explicitly configured for this domain. */}
              {(authMode === "login" || authMode === "register") && clientId ? (
                <>
                ...
                <div className="mt-5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/60 p-3 text-[11px] leading-relaxed text-zinc-500 dark:text-zinc-400">
                  Google Sign-In đang tạm tắt trên domain này để tránh lỗi ủy quyền. Bạn vẫn có thể đăng nhập hoặc tạo tài khoản bằng Email & Mật khẩu. Google sẽ tự bật lại khi GOOGLE_CLIENT_ID được cấu hình đúng cho domain Railway.
                </div>
              ) : null}
